...
PROCESSED_CONFIGS="::: $(spcom Args/Arch) ::: $(spcom Args/Cpu) ::: $(spcom Args/ni) ::: $(spcom Args/nj) ::: $(spcom Args/nk) ::: $(spcom Args/nl) ::: $(spcom Args/nm)"
