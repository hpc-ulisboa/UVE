...
extern void uve_config(void* src1/*data*/, uint64_t sizeN);
extern ResultType uve_kernel();
#else
extern ResultType core_kernel(void* src1, uint64_t sizeN);
#endif
...
int main( )
{
    ...
    if(src_1==NULL) {printf("Error allocating memory\n"); return -1;}
