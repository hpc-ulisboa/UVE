...
rmatmult3(Domain_t *domain, RadiationData_t *rblk, double *x, double *b) {
    ...
    asm volatile(
        ...
        "ss.app       u1, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u1, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u2, %1, %[sz], %[st] \t\n"
        "ss.app       u2, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u2, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u3, %2, %[sz], %[st] \t\n"
        "ss.app       u3, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u3, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u4, %3, %[sz], %[st] \t\n"
        "ss.app       u4, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u4, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u5, %4, %[sz], %[st] \t\n"
        "ss.app       u5, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u5, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u6, %5, %[sz], %[st] \t\n"
        "ss.app       u6, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u6, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u7, %6, %[sz], %[st] \t\n"
        "ss.app       u7, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u7, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u8, %7, %[sz], %[st] \t\n"
        "ss.app       u8, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u8, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u9, %8, %[sz], %[st] \t\n"
        "ss.app       u9, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u9, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u10, %9, %[sz], %[st] \t\n"
        "ss.app       u10, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u10, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u11, %10, %[sz], %[st] \t\n"
        "ss.app       u11, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u11, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u12, %11, %[sz], %[st] \t\n"
        "ss.app       u12, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u12, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u13, %12, %[sz], %[st] \t\n"
        "ss.app       u13, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u13, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u14, %13, %[sz], %[st] \t\n"
        "ss.app       u14, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u14, %[off3], %[sz3], %[st3] \t\n"
        :
        : "r"(dbl + offset), "r"(dbc + offset), "r"(dbr + offset),
          ...
          [st] "r"(1), [off2] "r"(jmin), [sz2] "r"(jmax - jmin), [st2] "r"(jp),
          [off3] "r"(kmin), [sz3] "r"(kmax - kmin), [st3] "r"(kp));
    asm volatile(
        "ss.sta.ld.d  u15, %0, %[sz], %[st] \t\n"
        "ss.app       u15, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u15, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u16, %1, %[sz], %[st] \t\n"
        "ss.app       u16, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u16, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u17, %2, %[sz], %[st] \t\n"
        "ss.app       u17, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u17, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u18, %3, %[sz], %[st] \t\n"
        "ss.app       u18, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u18, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u19, %4, %[sz], %[st] \t\n"
        "ss.app       u19, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u19, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u20, %5, %[sz], %[st] \t\n"
        "ss.app       u20, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u20, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u21, %6, %[sz], %[st] \t\n"
        "ss.app       u21, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u21, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u22, %7, %[sz], %[st] \t\n"
        "ss.app       u22, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u22, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u23, %8, %[sz], %[st] \t\n"
        "ss.app       u23, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u23, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u24, %9, %[sz], %[st] \t\n"
        "ss.app       u24, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u24, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u25, %10, %[sz], %[st] \t\n"
        "ss.app       u25, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u25, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u26, %11, %[sz], %[st] \t\n"
        "ss.app       u26, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u26, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u27, %12, %[sz], %[st] \t\n"
        "ss.app       u27, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u27, %[off3], %[sz3], %[st3] \t\n"
        "ss.sta.ld.d  u28, %13, %[sz], %[st] \t\n"
        "ss.app       u28, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u28, %[off3], %[sz3], %[st3] \t\n"
        :
    ...
    asm volatile(
        ...
        "ss.app       u30, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u30, %[off3], %[sz3], %[st3] \t\n"
        :
    ...
    asm volatile(
        ...
        "ss.app       u31, %[off2], %[sz2], %[st2] \t\n"
        "ss.end       u31, %[off3], %[sz3], %[st3] \t\n"
