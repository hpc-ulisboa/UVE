...
extern void uve_config(void* src1/*data*/, void*src2/*mean*/,  void*src3, uint64_t sizeN, uint64_t sizeM);
...
int main( )
{
    ...
    unsigned *src_3 = (unsigned*) malloc(sizeof(unsigned)*N*M);
    ...
    uve_config(src_1, src_2, src_3, N, M);
    // t22 = mysecond();
    result = uve_kernel();
