...
extern void uve_config2(void* src1, void*src2, void*src3, uint64_t sizeN);
extern ResultType uve_kernel();
#else
extern ResultType core_kernel(void* src1, void* src2, void* src3, void* src4, void* src5, uint64_t sizeN);
#endif
...
int main( )
{
    ...
    if(src_1==NULL || src_2==NULL || src_3==NULL || src_4==NULL || src_5==NULL) {printf("Error allocating memory\n"); return -1;}
    ...
    uve_config(src_1, src_2, src_3, N);
    result = uve_kernel();
    uve_config2(src_1, src_4, src_5, N);
    result = uve_kernel();
    // t22 = mysecond();
  #else // SVE, ARM, RISC-V, x86 code
    result = core_kernel(src_1, src_2, src_3, src_4, src_5, N);
  #endif
    M5resetdumpstats();
    t2 = mysecond();
